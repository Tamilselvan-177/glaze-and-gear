...
function ResetPasswordForm() {
  ...
  if (!token) {
    return (
      <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl w-full max-w-md text-center border border-red-100">
        ...
        <Link href="/forgot-password" className="bg-[#98202E] text-white px-6 py-3 rounded-xl font-bold inline-block">Request New Link</Link>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl shadow-[#98202E]/5 border border-[#98202E]/10 w-full max-w-md animate-in slide-in-from-bottom-4">
      <h1 className="text-3xl font-serif font-black text-center text-[#98202E] mb-2 uppercase tracking-widest">New Password</h1>
      <p className="text-center text-gray-500 mb-8 font-medium">Create a strong new password.</p>
