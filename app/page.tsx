...
export default async function HomePage() {
  ...
  return (
    <div className="bg-white min-h-screen text-[#98202E]">
      {/* Hero Section */}
      <section className="h-auto min-h-[70vh] md:min-h-screen pt-[120px] md:pt-0 pb-10 flex flex-col justify-start md:justify-center items-center text-center px-[5%] bg-[radial-gradient(circle_at_center,#fff_0%,var(--white)_100%)] relative">
        ...
        <div className="mt-8 md:mt-12 flex flex-wrap gap-4 justify-center">
          <Link href="/#shop" className="py-3 px-8 md:py-[1.2rem] md:px-[3rem] bg-[#98202E] text-white font-bold uppercase tracking-[2px] rounded md:rounded-md shadow-lg transition-transform hover:-translate-y-1 text-xs md:text-base">
            Shop Gifts
          </Link>
          <Link href="/gears" className="py-3 px-8 md:py-[1.2rem] md:px-[3rem] bg-transparent border-2 border-[#98202E] text-[#98202E] font-bold uppercase tracking-[2px] rounded md:rounded-md transition-transform hover:-translate-y-1 text-xs md:text-base">
            Explore Gears
          </Link>
        </div>
      </section>
