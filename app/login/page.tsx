...
function LoginContent() {
  ...
  // Handling callback errors (like when Google login fails or access denied)
  ...
  return (
    <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl shadow-[#98202E]/5 border border-[#98202E]/10 w-full max-w-md animate-in slide-in-from-bottom-4">
      <h1 className="text-3xl font-serif font-black text-center text-[#98202E] mb-2 uppercase tracking-widest">Welcome Back</h1>
      <p className="text-center text-gray-500 mb-8 font-medium">Log in to your Glaze & Gear account</p>
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <span className="text-xs text-gray-400 font-bold uppercase tracking-widest">or continue with email</span>
        <div className="h-px bg-gray-200 flex-1"></div>
      </div>
      ...
      <form onSubmit={handleCredentialsLogin} className="flex flex-col gap-4">
        ...
        <div>
          ...
          <div className="text-right mt-3">
            <Link href="/forgot-password" className="text-sm text-[#98202E] font-bold hover:underline transition-all">Forgot password?</Link>
          </div>
        </div>
        <button 
          disabled={loading}
      ...
      <p className="text-center text-gray-500 text-sm mt-8 font-medium">
        Don't have an account? <Link href="/register" className="text-[#98202E] font-bold hover:underline transition-all">Sign Up</Link>
      </p>
    </div>
  );
}
